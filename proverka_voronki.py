...
Второй слой (29.08): мёртвое не возвращается, живое не пропадает.
  ...
  · пути новой воронки (тест, разбор, запись на встречу, дневник, цепочка 7 дней)
    обязаны остаться достижимыми — уборка не имеет права унести живое.
...
LIVE_MODULES_REQUIRED = {
    ...
    "vstrecha",      # запись на встречу (29.08, вместо Calendly)
    "efir",          # запись на эфир-воркшоп и касания до него (13.09)
}

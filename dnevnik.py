...
# согласия — в таблице soglasiya. Та же дверь стоит и в Mini App (сервер отклоняет
# отметки без согласия, 403 no_consent — выкачено 15.09, сайт-репо app/proverka_soglasiya.py).
